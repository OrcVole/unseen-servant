...
by design (`docs/BRIEF.md`, `docs/ROADMAP.md`); new protocol features are
...
| Cloudron base image + manifest schema | `docs/recon/cloudron-fit.md`'s pinned digest and hard-constraints checklist going stale |
...
- `docs/BUILD-PLAN.md`'s C1–C7 exit gates, most already passed against a
  real, live install (not simulated) — see the git history for what was
  verified and how.
- The proving-grounds experiment protocol (`docs/BUILD-PLAN.md` C6) is
...
Forgejo issues on the canonical repo (`docs/BRIEF.md`) once the project is
public (`docs/ROADMAP.md` M6); until then, this file is the record of
