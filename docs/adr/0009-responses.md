...
- Date: 2026-08-09
- Evidence: docs/recon/community-wisdom.md, docs/notes/integration-ideas.md, director directives 2026-08-09
...
- Web side: plain no-JS form with the layered anti-spam from
  docs/notes/integration-ideas.md — honeypot, stateless HMAC
