...
| 4 | robots.txt companion | **Support now** (docs + skeleton only) | Official companion spec; it's just a static text/plain file; document virtual agents and mirror a robots.txt into the HTML output. |
